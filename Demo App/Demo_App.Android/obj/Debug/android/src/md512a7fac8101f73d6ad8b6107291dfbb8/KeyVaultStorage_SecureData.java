...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XLabs.Platform.Services.KeyVaultStorage+SecureData, XLabs.Platform.Droid, Version=2.3.0.0, Culture=neutral, PublicKeyToken=null", KeyVaultStorage_SecureData.class, __md_methods);
	}
	...
	public KeyVaultStorage_SecureData ()
	{
		...
		if (getClass () == KeyVaultStorage_SecureData.class)
			mono.android.TypeManager.Activate ("XLabs.Platform.Services.KeyVaultStorage+SecureData, XLabs.Platform.Droid, Version=2.3.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public KeyVaultStorage_SecureData (byte[] p0)
	{
		super ();
		if (getClass () == KeyVaultStorage_SecureData.class)
			mono.android.TypeManager.Activate ("XLabs.Platform.Services.KeyVaultStorage+SecureData, XLabs.Platform.Droid, Version=2.3.0.0, Culture=neutral, PublicKeyToken=null", "System.Byte[], mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0 });
	}
