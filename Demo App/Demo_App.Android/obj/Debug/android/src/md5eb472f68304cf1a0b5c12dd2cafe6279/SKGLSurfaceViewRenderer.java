...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SkiaSharp.Views.Android.SKGLSurfaceViewRenderer, SkiaSharp.Views.Android, Version=1.55.0.0, Culture=neutral, PublicKeyToken=0738eb9f132ed756", SKGLSurfaceViewRenderer.class, __md_methods);
	}
	...
	public SKGLSurfaceViewRenderer ()
	{
		...
		if (getClass () == SKGLSurfaceViewRenderer.class)
			mono.android.TypeManager.Activate ("SkiaSharp.Views.Android.SKGLSurfaceViewRenderer, SkiaSharp.Views.Android, Version=1.55.0.0, Culture=neutral, PublicKeyToken=0738eb9f132ed756", "", this, new java.lang.Object[] {  });
	}
