...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XLabs.Platform.Services.Geolocation.GeolocationContinuousListener, XLabs.Platform.Droid, Version=2.3.0.0, Culture=neutral, PublicKeyToken=null", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener ()
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("XLabs.Platform.Services.Geolocation.GeolocationContinuousListener, XLabs.Platform.Droid, Version=2.3.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
