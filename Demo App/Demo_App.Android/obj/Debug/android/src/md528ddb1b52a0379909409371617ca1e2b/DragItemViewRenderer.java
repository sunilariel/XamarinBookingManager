...
public class DragItemViewRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Syncfusion.ListView.XForms.Android.DragItemViewRenderer, Syncfusion.SfListView.XForms.Android, Version=16.1451.0.37, Culture=neutral, PublicKeyToken=null", DragItemViewRenderer.class, __md_methods);
	}


	public DragItemViewRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == DragItemViewRenderer.class)
			mono.android.TypeManager.Activate ("Syncfusion.ListView.XForms.Android.DragItemViewRenderer, Syncfusion.SfListView.XForms.Android, Version=16.1451.0.37, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public DragItemViewRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == DragItemViewRenderer.class)
	...
	public DragItemViewRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == DragItemViewRenderer.class)
